...
- **Do not reach for Better Auth unless self-service signup becomes a real requirement.** It works, but it takes the web Worker from 84 KiB to 1,939 KiB to serve a handful of accounts that never change. Basic auth over a secret does the job in a few dozen lines.
